 ...
 * so if that is what you have you can use only the two last rows. \texttt{dx*radius} is then the difference
 * between the two points in the x direction and \texttt{d*radius} is the total distance between the points.
