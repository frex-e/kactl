 ...
 * Date: 2026-01-13
 * License: CC0
 * Description: Fast bipartite matching algorithm. Graph \texttt{g} should be a list
 * of neighbors of the left partition, and \texttt{r} should be a vector full of
 * $-1$'s of the same size as the right partition. Returns the size of
 * the matching. \texttt{r[i]} will be the match for vertex $i$ on the right side,
