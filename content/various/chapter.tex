...
\section{Optimization tricks}
	...
	\subsection{Bit hacks}
		\begin{itemize}
			...
			\item \verb@__builtin_ctz(x)@ trailing zeros (\texttt{int}).
			\item \verb@__builtin_clzll(x)@ leading zeros (\texttt{ll}).
			\item \verb@__builtin_popcountll(x)@ number of ones.
		\end{itemize}
	\myneedspace{8\baselineskip}
	\subsection{Pragmas}
